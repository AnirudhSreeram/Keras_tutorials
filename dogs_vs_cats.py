...
model = Sequential([
    Conv2D(filters=32, input_shape=(224, 224, 3),
...
# Save the Model
if os.path.isfile('/home/anirudh/Documents/Keras_tutorials/dogs-vs-cats/model_1.h5') is False:
    model.save('/home/anirudh/Documents/Keras_tutorials/dogs-vs-cats/model_1.h5')

# Prediction usng the daved model
print("testing in progress")
print(test_batches.classes)
new_model = load_model('/home/anirudh/Documents/Keras_tutorials/dogs-vs-cats/model_1.h5')
